...
# save the dicts
with open('clip_activations_mean.json', 'w') as f:
    json.dump(activations_mean, f)

with open('clip_activations_sum.json', 'w') as f:
    json.dump(activations_sum, f)

with open('clip_activations_max.json', 'w') as f:
    json.dump(activations_max, f)

with open('clip_activations_max_abs.json', 'w') as f:
    json.dump(activations_max_abs, f)

with open('clip_attentions_entropy.json', 'w') as f:
    json.dump(attentions_entropy, f)

with open('clip_activations_delta.json', 'w') as f:
    json.dump(activations_delta, f)

with open('clip_activations_delta_total.json', 'w') as f:
    json.dump(activations_delta_total, f)

with open('clip_patch_regularity.json', 'w') as f:
