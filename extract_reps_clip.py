...
# save
with open('memcat_CLIP_reps_layer_LAST.json', 'w') as f:
    json.dump(selected_reps, f)

with open('memcat_CLIP_memscores_layer_LAST.json', 'w') as f:
    json.dump(mems, f)

# save dict
with open('memcat_CLIP_reps_dict_layer_LAST.json', 'w') as f:
